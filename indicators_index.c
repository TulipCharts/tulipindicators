...
struct ti_indicator_info ti_indicators[] = {
    ...
    {"ikhcs", "Ichimoku Chikou Span", ti_ikhcs_start, ti_ikhcs, TI_TYPE_OVERLAY, 1, 1, 1, {"high","low",0}, {"period",0}, {"ikhcs",0}},
    {"ikhts", "Ichimoku Tenkan-Sen", ti_ikhts_start, ti_ikhts, TI_TYPE_OVERLAY, 2, 1, 1, {"high","low",0}, {"period",0}, {"ikhts",0}},
